...
public class Cupcakes extends Generics {
	...
	public enum KeyType {
		combo, flavor, frosting, sprinkles
	};
	...
	public static Generics[] cupCakeData() {
		Generics[] cc = { new Cupcakes("Red", 4, "Red Velvet"), new Cupcakes("Orange", 5, "Orange"),
				new Cupcakes("Yellow", 6, "Lemon"), new Cupcakes("Green", 7, "Apple"),
				new Cupcakes("Blue", 8, "Blueberry"), new Cupcakes("Purple", 9, "Blackberry"),
				new Cupcakes("Pink", 10, "Strawberry"), new Cupcakes("Tan", 11, "Vanilla"),
