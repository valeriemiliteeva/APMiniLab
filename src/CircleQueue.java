...
public class CircleQueue {
	...
	/**
	 * Returns a string representation of this Queue, polymorphic nature of toString
	 * overrides of standard System.out.print behavior
	 *
	...
	public void insertionSort() {
		...
		while (node2 != null) {
			...
			LinkedList key = new LinkedList(node2); // note: make key a different object, persistent/static in value
													// (node2 moves)
