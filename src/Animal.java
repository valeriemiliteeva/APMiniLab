...
public class Animal extends Generics {
	...
	public static Generics[] animalData() {
		Generics[] ad = { new Animal("Lion", 8, "Gold"), new Animal("Pig", 3, "Pink"), new Animal("Robin", 7, "Red"),
				new Animal("Cat", 10, "Black"), new Animal("Kitty", 1, "Calico"), new Animal("Dog", 14, "Brown") };
		return ad;
	}
